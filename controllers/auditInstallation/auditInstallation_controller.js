...
const reviewMailContent = (installation, audit) => { return `
    ...
    <p>
      ...
      de emitir alegaciones para ser revisadas por HMES. En caso de que compruebes, que efectivamente, existe una justificación razonable para alegar un incumplimiento, 
      podrás realizar la alegación incluyendo toda aquella información que consideréis necesaria, fotos y/o comentarios.
    </p>
    <p>
      <b>
        El plazo de alegaciones será hasta el día 11/12/2024 inclusive.
      </b>
    </p>
    <p>
