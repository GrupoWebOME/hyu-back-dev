...
const reviewMailContent = (installation) => { return `
    ...
    <p>
      Antes de publicar los resultados definitivos, queremos ofrecerte la posibilidad de revisar aquellos incumplimientos que consideres puedan ser susceptibles de 
      emitir alegaciones para ser revisadas por HMES. En caso de que compruebes, que efectivamente, existe una justificación razonable para alegar un incumplimiento, 
      podrás realizar la alegación incluyendo toda aquella información que consideréis necesaria, fotos y/o comentarios.
    </p>
    <p>
      <b>
        El plazo de alegaciones será de una semana contado a partir del día de hoy.
      </b>
    </p>
    <p>
      Esta información se encuentra accesible a través de la aplicación Hyundai Standards Application (HSA) en el apartado Auditorías/ Alegaciones. 
