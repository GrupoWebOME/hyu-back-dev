...
const reviewMailContent = (installation, audit) => { return `
    ...
    <p>
      Antes de publicar los resultados definitivos, queremos recomendar la posibilidad de revisar aquellos incumplimientos que considera que pueden ser susceptibles de emitir alegaciones para ser 
      revisadas por HMES. En caso de que compruebe, que efectivamente, existe una justificación razonable para alegar un incumplimiento, podrá realizar la alegación incluyendo toda aquella información 
      que considere necesaria, fotos y/o comentarios.
    </p>
    <p>
      <b>
        El plazo de alegaciones será hasta el día 01/04/2025 inclusive.
      </b>
    </p>
    <p>
