...
const apiProductFamily = require('./productFamily/productFamily_routes')
const apiProvider = require('./provider/provider_routes')
...
const apiDealershipType = require('./dealershipType/dealership_type_routes')
...
api.use('/productFamily', apiProductFamily)
api.use('/provider', apiProvider)
api.use('/product', apiProduct)
api.use('/incidence', apiIncidence)
api.use('/order', apiOrder)
api.use('/dealershipType', apiDealershipType)
